            ...
            <div className="p-6 border-b border-gray-100 dark:border-slate-800 flex flex-col lg:flex-row gap-4 justify-between items-center bg-gray-50/50 dark:bg-[#0E192D]">
                <div className="flex items-center gap-2 w-full lg:w-auto">
                    ...
                    <select
                        ...
                        className="flex-1 lg:flex-none bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 text-gray-700 dark:text-gray-300 transition-all cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
