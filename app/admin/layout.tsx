        ...
        <div className="min-h-screen bg-gray-50 flex font-sans">
            ...
            <motion.aside
                ...
                animate={{
                    ...
                    width: "18rem" // Slightly wider for better breathing room
                }}
                transition={{ type: "spring", stiffness: 300, damping: 30 }}
                className={`fixed lg:static inset-y-0 left-0 z-50 bg-white border-r border-gray-200 shadow-xl lg:shadow-none flex flex-col h-screen ${!isSidebarOpen ? 'lg:hidden' : ''}`}
            >
                {/* Sidebar Header */}
                <div className="h-20 flex items-center px-8 border-b border-gray-100 bg-white">
                    <Shield className="w-8 h-8 text-red-600 mr-3" />
                    <span className="text-2xl font-black text-gray-900 tracking-tight">AutoScrap</span>
                </div>
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
                {/* Mobile Header */}
                <header className="lg:hidden h-16 bg-white border-b border-gray-200 flex items-center px-4 justify-between z-30">
                    <div className="flex items-center">
                        <button
