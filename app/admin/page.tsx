...
import { Shield, Clock, CheckCircle, Smartphone, MapPin, Car, Calendar, DollarSign } from "lucide-react"
        ...
        <div className="min-h-screen bg-gray-50 pt-24 pb-12 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                <div className="space-y-6">
                    <h2 className="text-xl font-bold text-gray-800 ml-1">Recent Valuations</h2>
